...
That's it! Your function is now active. Use the endpoint on the Details page to access the edge function
...
Write up your Edge Function requirement

<Image
  alt="Write up your Edge Function requirements for the assistant"
  src={{
    light: '/docs/img/guides/functions/dashboard/assistant-description--light.png',
    dark: '/docs/img/guides/functions/dashboard/assistant-description--light.png',
  }}
  zoomable
/>

And let Supabase Assistant do the rest
...
<Image
  alt="Deploy functions from the assistant"
  src={{
    light: '/docs/img/guides/functions/dashboard/assistant-function-deploy--light.png',
    dark: '/docs/img/guides/functions/dashboard/assistant-function-deploy--light.png',
  }}
  zoomable
/>

As you can see, this function requires an openAI API key. You can add the key in your Edge Functions secrets page, or ask Assistant for help.

<Image
  alt="Store API keys for Edge Functions"
  src={{
    light: '/docs/img/guides/functions/dashboard/function-keys--light.png',
    dark: '/docs/img/guides/functions/dashboard/function-keys--light.png',
  }}
  zoomable
/>

Once your variable is set, you can test by sending a request via the dashboard.

<Image
  alt="Test your function from the dashboard"
  src={{
    light: '/docs/img/guides/functions/dashboard/test--light.png',
    dark: '/docs/img/guides/functions/dashboard/test--light.png',
  }}
  zoomable
/>

Click on test, then provide a Request Body your function expects.
...
## Editing Functions From Dashboard

<Admonition type="caution" label="Be careful: there is currently no version control for edits">

We currently do not offer version control for functions. If you make edits and redeploy a function, you will irrecoverably overwrite the existing deployment.
...
4. You can also ask the Supabase Assistant to edit an existing function, and it will guide you through the process of updating and redeploying from the assistant.
